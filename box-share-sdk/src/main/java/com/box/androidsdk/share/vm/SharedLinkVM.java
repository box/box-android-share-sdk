...
public class SharedLinkVM extends BaseShareVM {
    ...
    public HashSet<BoxSharedLink.Access> getActiveRadioButtons() { //move to VM in the future
        HashSet<BoxSharedLink.Access> activeRadioButtons = new HashSet<>(3); //will be generated by ViewModel
