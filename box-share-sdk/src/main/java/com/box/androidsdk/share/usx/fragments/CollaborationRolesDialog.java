...
public class CollaborationRolesDialog extends DialogFragment implements Button.OnClickListener, DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.usx_fragment_collaboration_roles_dialog, null);
    ...
    private void addRolesToView(ArrayList<BoxCollaboration.Role> roles) {
        ...
        for (BoxCollaboration.Role role : BoxCollaboration.Role.values()) {
            ...
            View radioView = getActivity().getLayoutInflater().inflate(R.layout.usx_radio_item_roles, null);
        ...
        if (mAllowRemove) {
            ...
            View radioView = getActivity().getLayoutInflater().inflate(R.layout.usx_radio_item_remove, null);
