 ...
 */
public abstract class BoxThreadPoolExecutorActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSession.setSessionAuthListener(new BoxAuthentication.AuthListener() {
            ...
            public void onAuthFailure(BoxAuthentication.BoxAuthenticationInfo info, Exception ex) {
                finish();
                Toast.makeText(BoxThreadPoolExecutorActivity.this, R.string.box_sharesdk_session_is_not_authenticated, Toast.LENGTH_LONG).show();
            }
